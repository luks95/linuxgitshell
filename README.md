...
LinuxGitShell aims to provide a native, graphical Git experience for Linux, starting with KDE Plasma 6 and Dolphin on Manjaro/Arch Linux. The project is in its bootstrap phase; no Dolphin integration or Git operations are available yet.
...
The optional path is displayed only. Repository detection is planned for Phase 1.
